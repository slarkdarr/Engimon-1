...
Element::ElementAdv Element::elementAdv = {
    ...
    {std::make_pair(Ice, None), -5},
    {std::make_pair(None, Fire), -5},
    {std::make_pair(None, Water), -5},
    {std::make_pair(None, Electric), -5},
    {std::make_pair(None, Ground), -5},
    {std::make_pair(None, Ice), -5},
    {std::make_pair(None, None), -5},
};
